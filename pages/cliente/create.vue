    ...
    <b-row class="mt-4 section_custon">
      <b-col md="12">
        ...
        <b-form class="row" @submit.prevent="onSubmit()">
          <b-form-group label="Tipo Cliente:" label-for="tipo_cliente" class="col-md-4">
            <b-form-select
              id="tipo_cliente"
              v-model="form.tipo_cliente"
              :options="tipos_clientes"
              required
              @change="onChangeTipoCliente"
            />
          </b-form-group>
          ...
          <b-form-group label="Nome*:" label-for="nome" class="col-md-4">
            <b-form-input
              id="nome"
              v-model="form.nome"
              type="text"
          ...
          <b-form-group v-if="isPessoaFisica" label="Data de Nascimento:" label-for="data_nascimento" class="col-md-4">
            <b-form-input
              id="data_nascimento"
          ...
          <b-col cols="12" class="mt-4 d-flex justify-content-end">
            <nuxt-link to="/cliente" class="btn btn-outline-danger mr-2">Sair</nuxt-link>
...
export default {
  ...
  data () {
    return {
      ...
      tipos_clientes: [{ text: 'Selecione o tipo', value: null }, 'Pessoa Física', 'Pessoa Jurídica'],
  ...
  methods: {
    ...
    onChangeTipoCliente (event) {
      if (this.form.tipo_cliente === 'Pessoa Física') {
        this.isPessoaFisica = true
        this.isPessoaJuridica = false
      } else if (this.form.tipo_cliente === 'Pessoa Jurídica') {
